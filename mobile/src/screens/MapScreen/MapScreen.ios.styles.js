...
export default function createStyles(theme) {
    ...
    return StyleSheet.create({
        ...
        cardImg: { height: 180, backgroundColor: c.surfaceAlt },
        ...
        guestBadgeText: { fontSize: 12, fontWeight: '700', color: c.textPrimary },
        ...
        ratingIcon: { color: c.warning },
        ratingText: { fontSize: 14, color: c.textPrimary, fontWeight: '500' },
        categoryText: { fontSize: 15, color: c.iconMuted, marginBottom: 4 },
        nameText: { fontSize: 16, fontWeight: '600', color: c.textPrimary, marginBottom: 8 },
        priceLine: { fontSize: 16, color: c.textPrimary },
        priceValue: { fontWeight: 'bold' },
        priceUnit: { color: c.iconMuted, fontWeight: '300' },
        closeBtn: {
        ...
        closeBtnIcon: { color: c.textPrimary },
    });
}
